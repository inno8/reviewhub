    ...
    <main class="w-full max-w-md">
      ...
      <div class="flex flex-col items-center mb-10">
        <div class="mb-4 bg-surface-container-highest p-4 rounded-xl">
          <span class="material-symbols-outlined text-primary text-4xl">corporate_fare</span>
        </div>
        <h1 class="text-3xl font-extrabold tracking-tight text-on-surface">
          Review<span class="text-primary-container">Hub</span>
        </h1>
        <p class="text-on-surface-variant mt-2 text-sm tracking-wide">REGISTER YOUR ORGANIZATION</p>
      </div>
