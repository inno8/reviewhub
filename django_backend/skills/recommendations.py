...
class LearningRecommendationsView(APIView):
    ...
    def get(self, request):
        ...
        for pattern in high_freq_patterns:
            # Avoid duplicates by checking pattern_type against existing skill categories
            if not any(
        ...
        # 5. Add profile context (user level) for resource filtering
        ...
        # Annotate each recommendation with user level context
