    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('llm_provider', models.CharField(blank=True, help_text='openai, anthropic, or empty for OpenClaw fallback', max_length=20, null=True)),
                ('_llm_api_key', models.BinaryField(blank=True, db_column='llm_api_key', null=True)),
                ('llm_model', models.CharField(blank=True, help_text='e.g., gpt-4-turbo, claude-3-opus', max_length=50, null=True)),
